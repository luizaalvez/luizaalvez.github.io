...
const users = [
    ...
    { email: 'leo@gmail.com', password: '123', name: 'Leo' },
    { email: 'mayara@gmail.com', password: 'mayara123', name: 'Mayara' },
    { email: 'raissa@gmail.com', password: '123', name: 'Raissa' },
    { email: 'gab@gmail.com', password: '123', name: 'Gabriel' },
    { email: 'aaa@gmail.com', password: '123', name: 'AAA' },
    { email: 'ian@gmail.com', password: '123', name: 'Ian' }
];
